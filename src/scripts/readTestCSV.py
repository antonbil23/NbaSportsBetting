...
df_combined = pd.read_csv('./schedule/combined_2023.csv')
...
df.to_csv('/Users/rahul/Documents/Development/NbaSportsBetting/2012_to_2022_data.csv', index=False)

df_combined.columns = df_combined.columns.str.lower()
combined_df = pd.concat([df, df_combined], ignore_index=True)

# Print the combined dataframe
combined_df.to_csv('./schedule/2012_to_2023_data.csv', index=False)
